...
using RestWizclipService.Middlewares;
using RestWizclipService.Appmethods;
using RestWizclipService;
using Serilog;
...
//      .WriteTo.File("F:\\Services\\logs\\log.txt", rollingInterval: RollingInterval.Day)
//      .CreateLogger();

//    builder.Services.AddLogging(loggingBuilder =>
//    {
//        loggingBuilder.ClearProviders();
//        loggingBuilder.AddSerilog(Log.Logger); // Pass the Serilog logger instance here
//    });
//}
